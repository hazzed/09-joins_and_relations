...
app.post('/articles', function(request, response) {
  ...
  function queryThree(author_id) {
    client.query(
      `INSERT article INTO authors(author_id)`, // TODO: Write a SQL query to insert the new article using the author_id from our previous query
      [author_id], // TODO: Add the data from our new article, including the author_id, as data for the SQL query.
      function(err) {
        if (err) console.error(err);
